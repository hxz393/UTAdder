...
from ui.dialog_setup import DialogSetup
from ui.lang_manager import LangManager

logger = logging.getLogger(__name__)


class ActionSetup(QObject):
    """
    设置界面操作类。
    ...
    def init_ui(self) -> None:
        ...
        :return: 无返回值。
        """
        self.action_setting = QAction(QIcon(), 'Settings')
    ...
    def open_dialog(self) -> None:
        ...
        """
        try:
            self.dialog_settings_main = DialogSetup(self.lang_manager, self.config_manager)
